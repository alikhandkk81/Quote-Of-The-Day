...
function generateQuote(){
    const randomNumber = randomSelector(arrayOfQuotes.length);
    document.getElementById('quoteOutput').innerHTML = '""' + arrayOfQuotes[randomNumber].quoteText + '"';
    document.getElementById('authorOutput').innerHTML = '"' + arrayOfQuotes[randomNumber].quoteAuthor + '"';
}